...
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/RW_EX
...
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/PCSrc
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/FP_add_EX
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/FP_done
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Mem_ready
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Kill_IF
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Parar_ID
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Parar_EX
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Parar_MEM
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Parar_ID_signal
add wave -noupdate -group UD /testbench/uut/Unidad_detencion_riesgos/Parar_EX_signal

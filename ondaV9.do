...
add wave -noupdate -group MD_MC -expand /testbench/uut/MD_MC/MC/MC_data
...
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/mux_origen
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/hit
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/update_dirty
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/dirty_bit
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/replace_block
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/send_dirty
...
add wave -noupdate -group BR /testbench/uut/Register_bank/reg_file

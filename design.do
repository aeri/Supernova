...
add wave -noupdate -expand -group UD -color {Sea Green} /testbench/uut/Unidad_detencion_riesgos/Mem_ready
add wave -noupdate -expand -group UD -color {Medium Blue} /testbench/uut/Unidad_detencion_riesgos/Kill_IF
add wave -noupdate -expand -group UD -color Coral /testbench/uut/Unidad_detencion_riesgos/Parar_ID
add wave -noupdate -expand -group UD -color Coral /testbench/uut/Unidad_detencion_riesgos/Parar_EX
add wave -noupdate -expand -group UD -color Coral /testbench/uut/Unidad_detencion_riesgos/Parar_MEM
add wave -noupdate -group MD_MC /testbench/uut/MD_MC/MC/MC_data
add wave -noupdate -group MD_MC -expand /testbench/uut/MD_MC/MC/dir_MC
...
WaveRestoreCursors {{Cursor 1} {968 ns} 0}
